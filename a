...
function RayfieldLibrary:CreateWindow(Settings)
	...
	if Settings.Name ~= "ㄱㅇㅇ Hub" and Settings.LoadingTitle ~= "ㄱㅇㅇ Hub 로딩중" and Settings.LoadingSubtitle ~= "By ㄱㅇㅇ" and Settings.Discord.Invite ~= "F23AaWa5Cb" and Settings.Discord.Enabled == false then
		return nil
		return
	end
